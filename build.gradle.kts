...
tasks.register("pluginJarLatest", com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar::class.java) {
    ...
    exclude("com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_17_R1/**")
    exclude("com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_18_R1/**")
    exclude("com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_18_R2/**")
    exclude("com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R1/**")
    exclude("com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R2/**")
    exclude("com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R3/**")
    ...
    exclude("com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R4/**")
    exclude("com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R5/**")
    exclude("com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R6/**")
