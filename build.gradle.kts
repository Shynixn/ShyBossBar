    ...
    tasks.register(relocateTaskName, com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar::class.java) {
        ...
        if (isLegacy) {
            relocate(
                ...
                "com.github.shynixn.shybossbar.lib.com.github.shynixn.mccoroutine"
            )
            relocate(
                "com.github.shynixn.fasterxml",
                "com.github.shynixn.shybossbar.lib.com.github.shynixn.fasterxml"
            )
    ...
    tasks.register(jarTaskName, com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar::class.java) {
        ...
        if (excludeOldNms) {
            val oldNmsPaths = listOf(
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_8_R3/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_9_R2/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_17_R1/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_18_R1/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_18_R2/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R1/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R2/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R3/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R1/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R2/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R3/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R4/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R1/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R2/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R3/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R4/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R5/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R6/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R7/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v26_1_R1/**",
                "com/github/shynixn/shybossbar/lib/com/github/shynixn/mcutils/packet/nms/v26_2_R1/**"
            )
...
tasks.register("languageFile") {
    ...
    val contractFile = kotlinSrcFolder.resolve("com/github/shynixn/shybossbar/contract/ShyBossBarLanguage.kt")
    ...
    contractContents.add("package com.github.shynixn.shybossbar.contract")
    ...
    contractContents.add("")
    contractContents.add("interface ShyBossBarLanguage : LanguageProvider {")
    for (key in lines) {
    ...
    val implFile = kotlinSrcFolder.resolve("com/github/shynixn/shybossbar/ShyBossBarLanguageImpl.kt")
    val implContents = ArrayList<String>()
    implContents.add("package com.github.shynixn.shybossbar")
    implContents.add("")
    implContents.add("import com.github.shynixn.mcutils.common.language.LanguageItem")
    implContents.add("import com.github.shynixn.shybossbar.contract.ShyBossBarLanguage")
    implContents.add("")
    implContents.add("class ShyBossBarLanguageImpl : ShyBossBarLanguage {")
    implContents.add(
